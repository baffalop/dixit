...
export default class Loader extends Vue {
  @Prop({ type: Number, default: 10 }) readonly count!: number
}
</script>
...
<style lang="scss" scoped>
  ...
  source: https://codepen.io/animatedcreativity/pen/OjBPQJ
  found on: https://freefrontend.com/css-loaders/
   */
